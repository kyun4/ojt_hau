   ...
   <div class="row">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a target ="_blank" href = "/coor/student/view/evaluation_print/{{base64_encode($student->id)}}" type = "button" class = "btn btn-success btn-lg btn-block"><i class = "fa fa-print"></i> Print</a>
                    </div>
