    ...
    <form action="" method="post">
        ...
        <div class="row my-4" style="text-transform: uppercase">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-3">
                        <strong>Coordinator information </strong>
                        <hr />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input style='text-transform:uppercase;' type="text"  name="first_name" value="{{$student->first_name}}" class="form-control" id="">
                    </div>
                    <div class="col-md-4">
                        <strong>Middle Name</strong>
                        <input style='text-transform:uppercase;' type="text"  name="middle_name" value="{{$student->middle_name}}" class="form-control" id="">
                    </div>
                    <div class="col-md-4">
                        <strong>Last Name</strong>
                        <input style='text-transform:uppercase;' type="text"  name="last_name" value="{{$student->last_name}}" class="form-control" id="">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input style='text-transform:uppercase;' type="text"  name="year" value="{{$student->year}}" class="form-control" id="">
                            </div>
                            <div class="col-md-6">
                                <input style='text-transform:uppercase;' type="text"  name="section" value="{{$student->section}}" class="form-control" id="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <strong>Email </strong>
                        <input style='text-transform:lowercase;' type="email" name="email" value="{{$student->user->email}}" class="form-control" id="">
                    </div>
                    <div class="col-md-6">
