...
@endsection
@section('title')
Evaluation Result: {{$student->first_name}} {{$student->middle_name}} {{$student->last_name}}
@endsection
@section('content')
   <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th class="selections">5 – Excellent</th>
                        <th class="selections">4 – Very Good</th>
                        <th class="selections">3 – Good</th>
                        <th class="selections">2 - Average</th>
                        <th class="selections">1 – Needs Improvement</th>
                    </tr>
                    <tr>
            ...
            <div class="col-md-12 my-4">
                <button class="btn btn-primary" onclick="window.open('/partners/student/evaluation/{{base64_encode($student->id)}}','_parent')" type="submit">Update Evaluation</button>
            </div>
    </div>
@endsection
